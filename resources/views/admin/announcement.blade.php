    ...
    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                <h2 class="pageheader-title">Announcements</h2>
                            ...
                            <div class="card">
                                        ...
                                        <table class="table table-striped table-bordered first">
                                            ...
                                            <tbody>
                                                ...
                                                <tr id="tr-{{$post->PostID}}">
                                                    ...
                                                    <td>                                                        
                                                        <a title="Change" id="{{$post->PostID}}" class="change-announcement" href="#hidden-form"><i style="color: green" class="m-r-10 mdi mdi-pen"></i></a>
                                                        <a title="Delete" onclick="return confirm('Do you really want to delete the announcement?');" href="/sadmin/dashboard/blog/{{$post->PostID}}/delete"><i style="color:red" class="m-r-10 mdi mdi-delete-forever"></i></a>
                                                    </td>
                                                </tr>
                                                @endforeach
                                            </tbody>
                                ...
                                <div style="margin-bottom: 15px; margin-left: 17px">
                                    <div class="input-group">
                                        <button id="new-announcement" class="btn btn-primary">New announcement</button>
                                    </div>
...
<script>
    ...
    $('#new-announcement').click(function(){
        str = '<form method="post" action="/sadmin/dashboard/announcement/new">'
                + '     @csrf'
                + '     <label>Header</label>'
    ...
    $('.change-announcement').click(function(){
        ...
        $.when(getannouncement(this.id)).done(function(){
