                            ...
                            <div class="card">
                                        ...
                                        <table class="table table-striped table-bordered first">
                                            ...
                                            <tbody>
                                                ...
                                                <tr id="tr-{{$post->PostID}}">
                                                    ...
                                                    <td>                                                        
                                                        <a title="Change" id="{{$post->PostID}}" class="change-blog" href="#hidden-form"><i style="color: green" class="m-r-10 mdi mdi-pen"></i></a>
                                                        <a title="Delete" onclick="return confirm('Do you really want to delete the blog?');" href="/sadmin/dashboard/blog/{{$post->PostID}}/delete"><i style="color:red" class="m-r-10 mdi mdi-delete-forever"></i></a>
                                                    </td>
                                                </tr>
                                                @endforeach
                                            </tbody>
                                ...
                                <div style="margin-bottom: 15px; margin-left: 17px">
                                    <div class="input-group">
                                        <button id="new-blog" class="btn btn-primary">New blog</button>
                                    </div>
...
<script>
    ...
    $('#new-blog').click(function(){
        str = '<form method="post" action="/sadmin/dashboard/blog/new">'
                + '     @csrf'
                + '     <label>Header</label>'
    ...
    $('.change-blog').click(function(){
        ...
        $.when(getBlog(this.id)).done(function(){
